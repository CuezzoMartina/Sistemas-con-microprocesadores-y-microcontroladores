...
actualizar_reloj:
    ...
    LDR R8,=0x205
    LDR R0,=hora
    LDRB R1,[R0]        //R1=segundo unidad
    LDRB R2,[R0,#1]     //R2=segundo decena
    LDRB R3,[R0,#2]     //R3=min unidad
    LDRB R4,[R0,#3]     //R1=min decena
    LDRB R5,[R0,#4]     //R2=hs unidad
    LDRB R6,[R0,#5]     //R3=hs decena
    LDRH R7,[R0,#4]     //R3=hs decena
    ADD R1,#1
    CMP R1,#10
    ITT EQ
    MOVEQ R1,#0
