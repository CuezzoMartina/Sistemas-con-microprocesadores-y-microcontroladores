...
mostrar:
    // Configuraci�n de los pines de segmentos como gpio sin pull-up
    LDR R3,=SCU_BASE
    ...
    // Configuraci�n de los pines de digitos como gpio sin pull-up
    ...
    // Configuraci�n de los bits gpio de segmentos como salidas
    LDR R3,=GPIO_DIR0
    LDR R2,[R3,#(SEG_GPIO << 2)]
    ORR R2,#SEG_MASK
    STR R2,[R3,#(SEG_GPIO << 2)]

    // Configuraci�n de los bits gpio de digitos como salidas
    LDR R2,[R3,#(SEG_GPIO << 2)]
    ORR R2,#DIG_MASK
    STR R2,[R3,#(DIG_GPIO << 2)]
